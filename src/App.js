                ...
                return (
                  <div className="bg-gray-50 p-4 shadow-md overflow-x-auto" style={{ borderRadius: '9px' }}>
                    <div style={{ width: `${timelineWidth + 240}px`, minWidth: '100%' }}>
                      {/* Month header row */}
                      <div className="flex">
                        <div className="w-40 flex-shrink-0 sticky left-0 bg-gray-50" style={{ zIndex: 2 }}></div>
                          ...
                          return (
                            <div key={task.id}>
                              <div className="flex items-center gap-2 py-0.5">
                                <div className="w-40 flex-shrink-0 truncate text-xs text-gray-700 font-medium sticky left-0 bg-gray-50 pr-2" style={{ zIndex: 2 }} title={task.title}>{task.title}</div>
                              ...
                              {subtasksWithDates.map(sub => {
                                ...
                                return (
                                  <div key={sub.id} className="flex items-center gap-2 py-0.5">
                                    <div className="w-40 flex-shrink-0 truncate text-xs text-gray-500 pl-4 sticky left-0 bg-gray-50 pr-2" style={{ zIndex: 2 }} title={sub.text}>↳ {sub.text}</div>
