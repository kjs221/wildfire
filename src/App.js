          ...
          {currentView === 'hose' && !selectedTask && (
            <div>
              ...
              {tasks.length === 0 ? (
                ...
                return (
                  <div className="bg-gray-50 shadow-md" style={{ borderRadius: '9px', overflow: 'hidden', maxHeight: '75vh', overflowY: 'auto', overflowX: 'hidden' }}>
                    ...
                    <div style={{ width: `${timelineWidth + 240}px`, minWidth: '100%' }}>
                      ...
                      <div className="relative" style={{ padding: '4px 16px 16px' }}>
                        {/* Full-height Today line */}
                        <div style={{ position: 'absolute', top: 0, bottom: 0, left: `calc(160px + ${(todayOffset / totalDays) * (timelineWidth)}px)`, width: '1px', background: '#E24B4A', zIndex: 2, pointerEvents: 'none' }}></div>
