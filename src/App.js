...
const WildfireDashboard = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-8" style={{ background: 'linear-gradient(135deg, #0097b2 0%, #0078a0 100%)' }}>
      <div
          ...
          <div className="mb-6">
            <h1
              style={{
                ...
                fontSize: '60px',
                letterSpacing: '2px',
                background: 'linear-gradient(79deg, #ffa3a5, #ffbf81, #c52184)',
