          ...
          {currentView === 'hose' && !selectedTask && (
            <div>
              ...
              {tasks.length === 0 ? (
                ...
                return (
                  <div className="bg-gray-50 shadow-md" style={{ borderRadius: '9px', maxHeight: '75vh', overflowY: 'auto' }}>
                    <div style={{ overflowX: 'auto', minWidth: '100%' }}>
                    <div style={{ width: `${timelineWidth + 240}px`, minWidth: '100%' }}>
                      {/* Sticky month + today header */}
                      <div style={{ position: 'sticky', top: 0, zIndex: 10, background: '#f9fafb', paddingTop: '4px', paddingBottom: '2px', borderBottom: '1px solid #e5e7eb' }}>
                      {/* Month header row */}
                      <div className="flex">
                      ...
                      <div className="flex mb-2">
                        <div className="w-40 flex-shrink-0 sticky left-0 bg-gray-50" style={{ zIndex: 2, borderRadius: '9px' }}></div>
                        <div className="relative flex-1 border-b border-gray-300" style={{ height: '24px' }}>
                          <div className="absolute top-0 bottom-0 w-px bg-red-400" style={{ left: `${(todayOffset / totalDays) * 100}%` }}></div>
                          <span
                            className="absolute text-xs text-white font-medium px-1.5 py-0.5"
                            style={{
                      ...
                      <div style={{ padding: '4px 16px 16px' }}>
                        ...
                        {/* Full-height Today line — positioned over timeline area only */}
                        <div style={{ position: 'absolute', top: 0, bottom: 0, left: `calc(160px + 8px + ${(todayOffset / totalDays) * timelineWidth}px)`, width: '2px', background: '#E24B4A', zIndex: 2, pointerEvents: 'none', opacity: 0.6 }}></div>
                        {/* Sparks/potential contracts on Gantt */}
