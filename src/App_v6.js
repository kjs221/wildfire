            ...
            <div>
              ...
              {tasks.length === 0 ? (
                ...
                const barStyle = (startDate, endDate, color, progressPct) => {
                  ...
                  const e = endDate ? new Date(endDate) : new Date(startDate.getTime() + 86400000);
                          ...
                          return (
                            <div key={task.id}>
                              <div className="flex items-center gap-2 py-0.5">
                                <div className="w-40 flex-shrink-0 truncate text-xs text-gray-700 font-medium" title={task.title}>{task.title}</div>
                              ...
                              {subtasksWithDates.map(sub => {
                                ...
                                return (
                                  <div key={sub.id} className="flex items-center gap-2 py-0.5">
                                    <div className="w-40 flex-shrink-0 truncate text-xs text-gray-500 pl-4" title={sub.text}>↳ {sub.text}</div>
